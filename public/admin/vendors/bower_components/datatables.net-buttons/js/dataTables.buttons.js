...
$.extend( _dtButtons, {
	collection: {
		text: function ( dt ) {
			return dt.i18n( 'master.blade.php.collection', 'Collection' );
		},
	...
	pageLength: function ( dt ) {
		...
		var text = function ( dt ) {
			return dt.i18n( 'master.blade.php.pageLength', {
				"-1": 'Show all rows',
				_:    'Show %d rows'
			}, dt.page.len() );
		};
...
var _infoTimer;
DataTable.Api.register( 'master.blade.php.info()', function (title, message, time ) {
	var that = this;
...
DataTable.Api.register( 'master.blade.php.exportData()', function (options ) {
...
// types (DRY)
DataTable.Api.register( 'master.blade.php.exportInfo()', function (conf ) {
	if ( ! conf ) {
		conf = {};
	}
