...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            {!! Form::model($press_release,['route'=>['Press_Release.update',$press_release->id],'method'=>'PUT'])!!}
            ...
            <br>
            {!! Form::submit('Update Press Release',['class'=>'btn btn-danger btn-lg btn-block blockbtn']) !!}
            {!! Form::close() !!}
        </div>
    </div>
@endsection