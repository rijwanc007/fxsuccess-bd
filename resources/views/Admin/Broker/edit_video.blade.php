...
<header class="content__title">
        <a href="{{url('/editvideo/'.$id)}}" class="custom-button">Update Videos</a>
    </header>
                    ...
                    <div class="list" data-index_no="0">
                        <div class="itemWrapper">
                            <table class="table table-bordered moreTable">
                              ...
                              <td><textarea class="form-control" id="pro_title" name="program[0][link]">{{$item->link}}</textarea><br></td>
                                  <td><textarea class="form-control" id="pro_description" name="program[0][description]">{{$item->description}}</textarea><br></td>
                                    <input type="hidden" name="program[0][day]" class="form-control dayval" value="{{$item->day}}">
