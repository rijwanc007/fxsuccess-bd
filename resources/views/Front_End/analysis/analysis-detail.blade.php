          ...
          <div class="col-lg-12 forex-broker-info mt-1 mb-1-half">
            <div class="container-fluid text-dark-brown mb-1-half">
              <div class="row">
                ...
                {!!Form::open(['url'=>'/social/store/','method' => 'post','enctype'=>'multipart/form-data','id'=>'formcomment'])!!}
                ...
                <?php
                   $comments = DB::table('comments')->select('email','analysis_id','name','comment','created_at')->where('analysis_id','=',$analysis_detail_data->id)->orderBy('id','desc')->get();
                ?>
