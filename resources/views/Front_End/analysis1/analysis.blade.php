...
@section('analysis_status','active')
    <!--header bar-->
    <!--header bar end-->
          ...
          <div class="col-lg-6 col-sm-12 md-pl-1-half md-pr-1-half md-mt-1-half" id="seconddiv">
            <div class="mid-content position-relative">
              ...
              <header class="title-container">
                <h2 class="forex-header-second"><span>Forex Analysis</span></h2>
              </header>
                      ...
                      <div class="row">
                        <div class="col-md-3 md-no-pr toggle-adjust-left" align="middle">
                          <div class="zoom-img left-inner-img">
                            <img src="{{asset('../assets/img/city.jpg')}}" alt="">
                            <div class="inner-info-box">
                              <i class="fa fa-pencil"></i>
                              <span class="inner-info-month">Dec</span>
                              <span class="inner-info-date">15</span>
                              <span class="inner-info-year">2018</span>
                            </div>
                          </div>
                        </div>
                        <!-- Problem -->
                        <div class="col-md-9 md-pl-1-half toggle-adjust-right">
                          <div class="right-inner">
                            <h3>
                              <p class="text-left">Best Trading Signal Strategy For Trading</p>
                            </h3>
                            <!--Star Start-->
                            <div align=left>
                            ...
                            <div align=left style="font-size:13px">
                              <p class="text-justify strategy-p-limit">Lorem ipsum dolor sit amet, consectetur alter adipisicing elit. Facilis, natuse inse voluptates officia repudianda beatae magni es repudiandae beatae magni magnam autem natuse inse Lorem ipsum dolor sit amet, consectetur alter adipisicing elit. Facilis, natuse inse voluptates officia repudianda beatae magni es repudiandae beatae magni magnam autem natuse inse Lorem ipsum dolor sit amet, consectetur alter adipisicing elit. Facilis, natuse inse voluptates officia repudianda beatae magni es repudiandae beatae magni magnam autem natuse inse
                              </p>
                              ...
                              <a href="analysis-detail.html" target="_blank" class="ms-tag ms-tag-dark-warning text-right pull-right">Read More</a>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-9 md-pl-1-half toggle-adjust-right">
                          <div class="right-inner">
                            ...
                            <div align=left style="font-size:13px">
                              ...
                              <a href="#" class="ms-tag ms-tag-dark-warning text-right pull-right">Read More</a>
                            </div>
                          </div>
                        </div>
                      </div>
